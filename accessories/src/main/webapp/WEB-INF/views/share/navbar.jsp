...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="${contextRoot }/home">Accessory </a>
		</div>
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li id="listProducts"><a
					href="${contextRoot }/show/all/products">Accessories</a></li>
				<security:authorize access="hasAuthority('ADMIN')">
					<li id="manageProducts"><a
						href="${contextRoot }/manage/products">Manage Accessories</a></li>
				</security:authorize>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<security:authorize access="isAnonymous()">
					...
					<li id="manageProducts"><a href="${contextRoot }/login">Sign in</a></li>
