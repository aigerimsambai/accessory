		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="container">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="${contextRoot }/home">Service</a>
				</div>
			</div>
		</nav>
		...
		<div class="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-offset-3 col-md-6">
						<div class="panel">
							<div class="panel-heading" style="color:#ffffff; background-color: mediumpurple">
								<h4>Sign in</h4>
							</div>
								...
								<form action="${contextRoot }/login" method="post"
									...
									<div class="form-group">
										<div class="col-md-offset-4 col-md-8">
											<input type="submit" name="password" class="btn" style="background-color: mediumpurple; color:#ffffff"/>
